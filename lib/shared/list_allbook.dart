...
class ListAllbook extends StatelessWidget {
  const ListAllbook({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => BookCubit(Dio())..getAllBooks(),
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (c) => DetailsScreen(
                            image: allbook.cover,
                            title: allbook.title,
                            description: allbook.description,
                          ),
                        ),
                      );
                    },
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            width: 180.w,
                            height: 140.h,
                            child: Center(child: Image.network(allbook.cover)),
                          ),
                          Container(
                            width: 180.w,
                            height: 154.h,
